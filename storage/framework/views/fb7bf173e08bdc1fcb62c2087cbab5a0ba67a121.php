                                        ...
                                        <div class="row">
                                            <div class="col-md-6 md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" name="fname" class="form-control" id="fname" placeholder="Enter first name">
                                                </div>
                                            </div>
                                            <div class="col-md-6 md-4">
                                                <div class="form-group">
                                                    <label for="lname">User last name</label>
                                                    <input type="name" name="lname" class="form-control" id="lname" placeholder="Enter last name">
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Web Development\Laravel\Blog-app\resources\views/admin/user/create.blade.php ENDPATH**/ ?>