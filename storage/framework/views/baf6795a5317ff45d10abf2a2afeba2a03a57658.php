...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="<?php echo e(route('forget.password.get')); ?>">Forgot password?</a></p>
      
                    <button class="btn btn-outline-light btn-lg px-5" type="submit">Login</button>
                  </form>
      
                    <div class="d-flex justify-content-center text-center mt-4 pt-1">
                      <a href="<?php echo e(route('login.facebook')); ?>" class="text-white"><i class="fab fa-facebook-f fa-lg"></i></a>
                      <a href="<?php echo e(route('login.github')); ?>" class="text-white"><i class="fab fa-github fa-lg mx-4 px-2"></i></a>
                      <a href="<?php echo e(route('login.google')); ?>" class="text-white"><i class="fab fa-google fa-lg"></i></a>
                    </div>
...
</html><?php /**PATH G:\Web Development\Laravel\Blog-app\resources\views/auth/login.blade.php ENDPATH**/ ?>