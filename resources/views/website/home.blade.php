    ...
    <div class="container">
      <div class="row align-items-stretch retro-layout-2">
        <div class="col-md-4">
          ...
          <a href="{{ route('website.post', ['slug' => $post->slug]) }}" class="h-entry mb-30 v-height gradient" style="background-image: url({{ asset('storage/'.$post->image) }});">
          ...
          <div class="entry2">
            ...
            <div class="post-meta align-items-center text-left clearfix">
              <figure class="author-figure mb-0 mr-3 float-left">
                <img src="@if($post->user->image){{ asset('storage/'.$post->user->image) }} @else {{ asset('storage/'.$post->user->image) }} @endif" alt="Image" class="img-fluid">
              </figure>
